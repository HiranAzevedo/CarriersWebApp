    ...
    public partial class initial : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                c => new
                    {
                        CarriersId = c.Int(nullable: false, identity: true),
                        Description = c.String(),
                        Name = c.String(),
                        CreateDate = c.DateTime(),
                        UpdateDate = c.DateTime(),
                    })
                .PrimaryKey(t => t.CarriersId);
            ...
            CreateTable(
                ...
                .PrimaryKey(t => new { t.RateId, t.UserId })
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Rate", "CarrierId", "dbo.Carrier");
            ...
            DropIndex("dbo.Rate", new[] { "CarrierId" });
